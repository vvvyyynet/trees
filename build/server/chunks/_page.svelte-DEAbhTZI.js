function _page($$payload) {
  $$payload.out += `<div class="mt-5 w-full px-4 md:mt-10 md:max-w-[1200px] md:px-20"><p>Trees are of central importance to urban life, providing vital services for the urban climate,
		...
		resulting conservation concepts.</p> <img class="mx-auto mt-24" src="/images/Visualisierung_Baumoekosysteme.png" alt="Visualisierung Baumökosysteme"></div>`;
}

export { _page as default };
//# sourceMappingURL=_page.svelte-DEAbhTZI.js.map
