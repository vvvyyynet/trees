...
function _page($$payload, $$props) {
  ...
  let filteredFiles = (() => {
    ...
    if (textChips.length > 0) {
      files = files.filter((file) => {
        ...
        {
          return textChips.every((chip) => fullText.toLowerCase().includes(chip.toLowerCase()));
        }
      });
    }
    return files;
  ...
  function $$render_inner($$payload2) {
    ...
    $$payload2.out += `<!--]--></button> `;
    {
      ...
      $$payload2.out += `<!--]--></div></div> <div class="mb-4"><h2 class="mb-2 text-xs">filter by text</h2>  <div class="grid w-full grid-cols-[1fr_auto] rounded-full border border-black px-4 py-0">`;
      InputChip($$payload2, {
    ...
    for (let $$index_6 = 0, $$length = each_array_3.length; $$index_6 < $$length; $$index_6++) {
      ...
      $$payload2.out += `<tr><td class="w-[200px] svelte-16n6pyh"><div class="mb-4 text-lg md:text-xl">${html(marked(highlightText(file.title, textChips)))}</div> <div class="mt-2 flex flex-col gap-2 pl-4"><div class="flex flex-wrap gap-2"><!--[-->`;
      ...
      for (let $$index_5 = 0, $$length2 = each_array_6.length; $$index_5 < $$length2; $$index_5++) {
        ...
        $$payload2.out += `<td class="w-[200px] svelte-16n6pyh"><p class="prose text-sm">${html(marked(highlightText(H2block.content, textChips)))}</p></td>`;
      }
      $$payload2.out += `<!--]--></tr>`;
    }
...
//# sourceMappingURL=_page.svelte-CBOklFqE.js.map
